...
action :setup do
  ...
  %W{ #{new_resource.name} #{new_resource.name}/current #{new_resource.name}/current/config #{new_resource.name}/current/vendor #{new_resource.name}/current/public #{new_resource.name}/current/tmp #{new_resource.name}/shared #{new_resource.name}/shared/config #{new_resource.name}/shared/vendor #{new_resource.name}/shared/public #{new_resource.name}/shared/tmp }.each do |dir|
