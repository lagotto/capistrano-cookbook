actions :deploy, :config, :bundle_install, :npm_install, :bower_install, :precompile_assets, :migrate, :restart
...
attribute :npm_config_prefix, :kind_of => String, :default => node['npm']['npm_config_prefix']
