actions :deploy, :config, :bundle_install, :npm_install, :bower_install, :consul_install, :precompile_assets, :ember_build, :migrate, :restart
...
attribute :atlas_key, :kind_of => String
